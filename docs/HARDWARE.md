...
| **ESP32‑P4‑WIFI6‑Touch‑LCD‑X 8"** | Counter‑top companion | 8" 1280×800, MIPI‑DSI (JD9365) | **Yes — external opto.** Same wiring as the P4‑5 | Finished box, biggest screen, same P4 electronics as the LCD‑5. UI scaled 1.6×. Verified on hardware (v3 silicon). |
