...
constexpr int kStatsInfoRows = 10;  // device-info table rows (see kInfoKeys)
...
struct StatsWidgets {
  ...
  lv_obj_t* update_btn = nullptr;        // Firmware row "Check for updates"
  ...
  lv_obj_t* history_sd_label = nullptr; // footer right: "SD: x free of y" / FULL
  lv_obj_t* history_url_label = nullptr; // footer center: "View at http://<ip>"
